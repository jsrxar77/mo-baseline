# ALCANCE ESTRATÉGICO DE PAUTA: DRINK LOVERS
**Objetivo:** Adquisición y rentabilidad e-commerce (ROAS/POAS) sobre catálogo sincronizado (265 SKUs en stock).
...
## 3. HOJA DE RUTA DE IMPLEMENTACIÓN RÁPIDA

| Fase | Canal | Acción Concreta | Impacto Esperado |
| :--- | :--- | :--- | :--- |
| **Fase 1 (Inmediata)** | Meta Ads | Lanzar **DPA Retargeting** + **DPA Prospección** con conjunto `Drink Lovers - En Stock`. | Recuperar carritos abandonados y activar primeras ventas dinámicas. |
| **Fase 2 (Nicho High-Ticket)** | Meta & Google | Pauta segmentada para **Whiskies Orientales** y **Macallan** (Search exacto + Carrusel DPA). | Incrementar el Ticket Promedio (AOV). |
| **Fase 3 (Escala)** | Google Ads | Configurar Google Merchant Center + **Performance Max** con los 265 SKUs activos. | Dominar el bloque visual de Google Shopping en Argentina. |
